<template>
  <div class="relative bg-[#EDEDE9] rounded-[35px] h-[450px] w-[400px] select-none mb-8 hover:shadow-md transition-all duration-300 ease-in-out">
    ...
    <router-link :to="uri">
      <img :src="props.item.imageUrl" class="h-[324px] w-full rounded-[35px]" draggable="false" alt="">
